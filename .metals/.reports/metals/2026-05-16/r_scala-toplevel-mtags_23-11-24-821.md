error id: file://<WORKSPACE>/introductory/functions.scala:[76,76) in virtfile:file://<WORKSPACE>/introductory/functions.scala(... @main
def )
file://<WORKSPACE>/file:<WORKSPACE>/introductory/functions.scala
file://<WORKSPACE>/introductory/functions.scala:7: error: expected identifier; obtained eof
