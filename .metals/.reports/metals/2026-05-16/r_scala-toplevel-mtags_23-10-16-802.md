error id: file://<WORKSPACE>/introductory/functions.scala:[10,10) in virtfile:file://<WORKSPACE>/introductory/functions.scala(@main
def )
file://<WORKSPACE>/file:<WORKSPACE>/introductory/functions.scala
file://<WORKSPACE>/introductory/functions.scala:2: error: expected identifier; obtained eof
