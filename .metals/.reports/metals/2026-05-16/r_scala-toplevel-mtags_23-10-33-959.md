error id: file://<WORKSPACE>/introductory/functions.scala:[4,5) in virtfile:file://<WORKSPACE>/introductory/functions.scala(def @

@main
)
file://<WORKSPACE>/file:<WORKSPACE>/introductory/functions.scala
file://<WORKSPACE>/introductory/functions.scala:1: error: expected identifier; obtained at
